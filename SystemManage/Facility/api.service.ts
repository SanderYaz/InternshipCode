...
export class ApiService {
  ...
  updateFacility(facility): Observable<any> {
    const body = { company: facility.company,  facilitytype: facility.facilitytype, name: facility.name, responsible_person: facility.responsible_person, address: facility.address, phone: facility.phone, coordinate: facility.coordinate, responsibe_engineer: facility.responsible_engineer };
