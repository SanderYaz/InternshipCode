...
@Component({
  selector: 'app-stockmovement-counting',
  templateUrl: './stockmovement-counting.component.html',
  styleUrls: ['./stockmovement-counting.component.scss'],
  encapsulation: ViewEncapsulation.None,
  providers: [ApiService, ToasterService]
})
export class StockmovementCountingComponent implements OnInit {
