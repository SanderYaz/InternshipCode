...
@Component({
  selector: 'app-stockmovement-countingexit',
  templateUrl: './stockmovement-countingexit.component.html',
  styleUrls: ['./stockmovement-countingexit.component.scss'],
  encapsulation: ViewEncapsulation.None,
  providers: [ApiService, ToasterService]
})
export class StockmovementCountingexitComponent implements OnInit {
