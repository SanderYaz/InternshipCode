...
@Component({
  selector: 'app-stockmovement-create',
  templateUrl: './stockmovement-create.component.html',
  styleUrls: ['./stockmovement-create.component.scss'],
  encapsulation: ViewEncapsulation.None,
  providers: [ApiService, ToasterService]
})
export class StockmovementCreateComponent implements OnInit {
